        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="font-bold text-xl">Academic Excellence</span>
            </div>
            <p className="text-gray-400 mb-4 max-w-md">
              Your digital academic coach providing personalized insights and nudges to help students excel in their academics. Track progress, predict risk areas, and get targeted recommendations.
            </p>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2025 Academic Excellence Assistant. All rights reserved.
            </p>
